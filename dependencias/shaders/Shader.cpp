...
bool Shader::compileShaderProgram(const char* vertex_shader_path, const char* fragment_shader_path)
{
...
void Shader::checkCompileErrors(unsigned int id, int type) const
{
    int success;
	char infoLog[512];
    if (type == SHADER_COMP) 
